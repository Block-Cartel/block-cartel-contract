...
contract sBLOCKS is IsBLOCKS, ERC20Permit {
    ...
    constructor() ERC20("Staked BLOCKS", "sBLOCKS", 9) ERC20Permit("Staked BLOCKS") {
    ...
    /**
        @notice increases rBLOCKS supply to increase staking balances relative to profit_
    ...
    function rebase(
        uint256 profit_,
        uint256 epoch_
    ) public override onlyStakingContract returns ( uint256 ) {
    ...
    function balanceOf(
        address who
    ) public view override(IsBLOCKS, ERC20) returns ( uint256 ) {
    ...
    // Staking contract holds excess rBLOCKS
